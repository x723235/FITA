# FITA — acordos do produto

- Falar com Rafael em português brasileiro, com clareza, intimidade leve e humor natural; tratá-lo como engenheiro sênior.
- O nome FITA foi explicitamente aprovado. Preservar a identidade de arquivo de vozes.
- Precisão multilíngue e reconhecimento de vozes têm prioridade sobre velocidade.
- Identidade de pessoa só é incorporada por confirmação. Palpites não treinam perfis.
- Preservar áudios e transcrições originais; correções e interpretações ficam separadas e com proveniência.
- Menus devem fazer sentido: Gravações, Fila, Revisar, Pessoas. Referências ASCII/Windows/boot não justificam usabilidade ruim.
- A direção de fundo é Floating Focus Ambient/Aura. Texto deve continuar legível; movimento e intensidade devem poder ser reduzidos.
